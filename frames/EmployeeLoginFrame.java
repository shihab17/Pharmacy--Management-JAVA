...
public class EmployeeLoginFrame extends JFrame implements ActionListener, MouseListener
{
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			// EmployeeFrame eF = new EmployeeFrame(admin);
			...
			else
			{
				...
				JOptionPane.showMessageDialog(null,"Invaild Id or Password");
			}
